...
def main():
    ...
    defaults = {
        ...
        '--project': 'exp50_adaptive_backbone_stgformer_spatiotemporal_hist168_pred3_8anchors_seed0_bs16',
        '--pred_len': '3',
        '--hist_len': str(24 * 7),
        '--batch_size': '16',
        '--device': 'auto',
        ...
        '--stgformer_temporal_residual': 'true',
        ...
        '--stgformer_spatial_transformer': 'true',
