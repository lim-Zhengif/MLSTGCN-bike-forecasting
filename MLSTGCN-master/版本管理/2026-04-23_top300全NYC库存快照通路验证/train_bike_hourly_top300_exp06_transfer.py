...
SOURCE_VERSION_DIR = os.path.join(PROJECT_ROOT, '版本管理', '2026-04-09_小时级骑入骑出_安全库存区间')
...
def main():
    ...
    defaults = {
        '--data_dir': os.path.join('data', 'temporal_data', 'bike_hourly_safe_inventory_top300_nyc_full'),
        '--graph_dir': os.path.join('data', 'graph', 'bike_hourly_safe_inventory_top300_nyc_full'),
        '--project': 'bike_hourly_safe_inventory_top300_nyc_full_exp06_transfer_bs4',
        '--pred_len': '24',
        '--hist_len': str(24 * 7),
        '--batch_size': '4',
        '--device': 'auto',
