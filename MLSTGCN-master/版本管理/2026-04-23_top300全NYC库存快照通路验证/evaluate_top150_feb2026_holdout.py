...
def find_best_checkpoint(project_name):
    pattern = PROJECT_ROOT / "logs" / project_name / "version_0" / "checkpoints" / "best-*.ckpt"
...
def main():
    ...
    model_config = {"cheb_k": 3, "nb_block": 2, "nb_chev_filter": 64, "nb_time_filter": 64, "time_kernel_size": 3}
