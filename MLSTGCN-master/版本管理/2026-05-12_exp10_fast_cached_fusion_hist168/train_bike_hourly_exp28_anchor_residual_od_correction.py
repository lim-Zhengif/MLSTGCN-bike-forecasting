...
def main():
    ...
    defaults = {
        ...
        '--project': 'exp28_anchor_residual_od_correction_res09_prior01_hist168_pred6_seed0',
        '--pred_len': '6',
        '--hist_len': str(24 * 7),
        '--batch_size': '8',
        '--device': 'auto',
        ...
        '--context_gate_anchor_od_prior': '0.1',
        '--context_gate_residual': '0.9',
        '--context_gate_scope': 'od_residual_correction',
