...
def main():
    ...
    parser.add_argument("--project", default="bike_hourly_safe_inventory_top150_exp10_anchor_hour_od_rolling6h_train2025_hist168_bs8_seed0")
    ...
    graph_config = {
        "use": ["dist", "neighb", "distri", "tempp", "func", "od00", "od06", "od12", "od16", "od20"],
        "fix_weight": False,
