...
def main():
    ...
    defaults = {
        ...
        '--project': 'exp40_anchor_horizon_graph_fusion_res08_dec02_hist168_pred3_8anchors_seed0',
        '--pred_len': '3',
        '--hist_len': str(24 * 7),
        '--batch_size': '8',
        '--device': 'auto',
        ...
        '--horizon_graph_fusion_gate': 'true',
        '--horizon_graph_fusion_decoder': 'true',
        '--horizon_graph_gate_residual': '0.8',
        '--horizon_graph_decoder_residual': '0.2',
        '--horizon_graph_hidden_dim': '32',
        '--horizon_graph_anchor_embed_dim': '8',
        '--horizon_graph_horizon_embed_dim': '4',
