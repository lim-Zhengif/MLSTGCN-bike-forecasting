...
def main():
    ...
    defaults = {
        ...
        '--project': 'exp20_peak_finetune_from_exp10_seed1',
        '--pred_len': '6',
        '--hist_len': str(24 * 7),
        '--batch_size': '8',
        '--device': 'auto',
        ...
        '--loss': 'huber',
        '--huber_delta': '2.0',
        '--train_anchor_hours': '6,12,16',
        '--peak_anchor_loss_weight': '1.0',
        '--peak_anchor_hours': '6,12,16',
        ...
        '--init_checkpoint': os.path.join(
            'wandb',
            'run-20260513_160340-34rb64u0',
            'files',
            'top150_rolling6h_model_compare',
            '34rb64u0',
            'checkpoints',
            'best-epoch=48-val_mae_epoch=val_mae_epoch=3.9888.ckpt',
        ),
    }
