...
def main():
    ...
    defaults = {
        ...
        '--project': 'exp43a_sthybrid_full_light_lambda005_ms_alpha01_hist168_pred3_8anchors_seed0_bs16',
        '--pred_len': '3',
        '--hist_len': str(24 * 7),
        '--batch_size': '16',
        '--device': 'auto',
        ...
        '--state_graph_correction': 'true',
        '--state_graph_lambda': '0.05',
        '--state_graph_topk': '20',
        '--state_graph_embed_dim': '16',
        '--state_graph_hidden_dim': '32',
        '--state_graph_symmetric': 'false',
        '--state_graph_keep_self': 'true',
        '--ast_tcn_residual': 'false',
        '--sthybrid_ms_residual': 'true',
