...
def main():
    ...
    defaults = {
        ...
        '--project': 'exp47_hgaurban_edge_bias_only_gamma003_ast_tcn_edge_bias005_hist168_pred3_8anchors_seed0_bs16',
        '--pred_len': '3',
        '--hist_len': str(24 * 7),
        '--batch_size': '16',
        '--device': 'auto',
        ...
        '--hgaurban_graph_prior_path': os.path.join(
            '分析结果',
            '2026-06-09_expHGAurban_pretrain',
            'pretrain_top150_pred3_8anchors',
            'hgaurban_graph_prior.npy',
        ),
        ...
        '--ast_tcn_hgaurban_edge_bias': 'true',
        '--ast_tcn_hgaurban_edge_bias_init': '0.03',
