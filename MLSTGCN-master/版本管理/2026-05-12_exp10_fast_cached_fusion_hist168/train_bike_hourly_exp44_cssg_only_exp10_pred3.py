...
def main():
    ...
    defaults = {
        ...
        '--project': 'exp44_cssg_only_exp10_fast_cached_fusion_hist168_pred3_8anchors_seed0_bs16',
        '--pred_len': '3',
        '--hist_len': str(24 * 7),
        '--batch_size': '16',
        '--device': 'auto',
        ...
        '--matrix_weight': 'true',
        '--time_kernel_size': '3',
        '--graph_use': 'dist,neighb,distri,tempp,func,od00,od03,od06,od09,od12,od15,od18,od21,cssg_rw',
        '--cssg_rw_graph_prior_path': os.path.join(
            '分析结果',
            '2026-06-15_expCSSG_rw_prior',
            'cssg_rw_top150_pred3_8anchors',
            'cssg_rw_graph_prior.npy',
        ),
        '--ast_tcn_residual': 'false',
        '--sthybrid_ms_residual': 'false',
        '--state_graph_correction': 'false',
