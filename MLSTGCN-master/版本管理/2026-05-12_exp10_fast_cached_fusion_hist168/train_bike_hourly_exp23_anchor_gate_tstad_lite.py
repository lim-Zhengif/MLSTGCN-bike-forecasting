...
def main():
    ...
    defaults = {
        ...
        '--project': 'exp23_anchor_gate_tstad_lite_hist168_pred6_seed0',
        '--pred_len': '6',
        '--hist_len': str(24 * 7),
        '--batch_size': '8',
        '--device': 'auto',
        ...
        '--context_gate_anchor_od_prior': '1.0',
        '--context_gate_residual': '0.1',
        '--context_gate_scope': 'od_only',
        '--anchor_homogeneous_batches': 'true',
        '--trend_alignment_decoder': 'true',
        '--trend_time_feature_index': '3',
        '--trend_time_cycle': '24',
