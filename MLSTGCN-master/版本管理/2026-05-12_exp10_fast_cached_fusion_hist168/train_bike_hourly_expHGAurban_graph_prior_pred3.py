...
def main():
    ...
    defaults = {
        ...
        '--project': 'expHGAurban_graph_prior_ast_tcn_edge_bias_hist168_pred3_8anchors_seed0',
        '--pred_len': '3',
        '--hist_len': str(24 * 7),
        '--batch_size': '8',
        '--device': 'auto',
        ...
        '--matrix_weight': 'true',
        '--time_kernel_size': '3',
        '--graph_use': 'dist,neighb,distri,tempp,func,od00,od03,od06,od09,od12,od15,od18,od21,hgaurban',
